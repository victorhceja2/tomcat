...
<%--
##########################################################################################################
# Nombre Archivo  : CouponReportFrm.jsp
# Compania        : Yum Brands Intl
# Autor           : Mario Chavez
# Objetivo        : Mostrar El reporte de cupones
# Fecha Creacion  : 12/Mayo/2008
# Inc/requires    : ../Proc/CouponReportLibYum.jsp
# Observaciones   : Se tiene que declarar un objecto moAbcUtils para que se pueda hacer 
#                   uso de los metodos en la libreria CouponReportLibYum.jsp
##########################################################################################################
--%>
...
<%@ include file="../Proc/CouponReportLibYum.jsp" %>   
...
<%
    ...
    moHtmlAppHandler.msReportTitle = getCustomHeader("Reporte de cupones", msTarget);
...
<html>
    <head>
        ...
        <script src="../Scripts/CouponReportYum.js"></script>
        ...
        //Estas dos variables son requeridas en el Script CouponReportYum.js
