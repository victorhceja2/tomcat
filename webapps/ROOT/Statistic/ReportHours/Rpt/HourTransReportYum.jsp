<%--
##########################################################################################################
# Nombre Archivo  : HourTransYum.jsp     
...
<%
    ...
    {
        System.out.println("Exception  de HourTransReportYum.. " + e);
    }
...
<html>
        ...
        <script>
            ...
            function doAction()
            {
                ...
                {    
                    ...
                    addHidden(document.mainform, 'hidTitle', 'Resumen OD Horarios');
    ...
    <body onLoad=" doAction()" style="margin-left: 0px; margin-right: 0px">
        ...
        <form name="mainform" action="HourTransReportFrm.jsp">
