...
<%--
##########################################################################################################
# Nombre Archivo  : PiecesReportYum.jsp
# Compania        : Yum Brands Intl
# Autor           : Eduardo Zarate - Laliux
# Objetivo        : Muestra reporte grafico de Piezas por Transaccion
...
<%@ page import = "org.jfree.chart.title.Title" %>
<%@ page import = "org.jfree.chart.entity.StandardEntityCollection" %>
<%@ page import = "org.jfree.chart.servlet.*" %>
<%@ page import = "org.jfree.chart.labels.StandardXYLabelGenerator" %>
...
<%@ page import = "org.jfree.ui.Spacer" %>
...
<%! AbcUtils moAbcUtils = new AbcUtils();
	...
	{
		return createPiecesDataset(numWeeks, begindate);
	}
%>
...
<%
    try
    {
		...
		if(msReport.equals("3"))//Se tiene que escoger un dia
		{
			...
			Date limitdate = dateformat.parse(calculateLimitDate(14)); //fecha limite de 14 dias
			...
			{
				filename = generateChart(session, new PrintWriter(out), begindate, "Piezas por transaccion");
...
<FRAMESET rows="99%, 1%" border="0">
      <FRAME src="PiecesReportFrm.jsp?target=Preview&graphURL=<%= graphURL %>&msMsg=<%= msMsg %>" name="preview" frameborder="0">
      <FRAME src="PiecesReportFrm.jsp?target=Printer&graphURL=<%= graphURL %>&msMsg=<%= msMsg %>" name="printer" frameborder="0">
</FRAMESET>
