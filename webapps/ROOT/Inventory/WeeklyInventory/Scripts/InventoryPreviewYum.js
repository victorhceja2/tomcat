	...
	function customDataset(paDataset, fontSize)
	{
		...
		for(var idx=0; idx<paDataset.length; idx++)
		{
			...
			paDataset[idx][8] = '<div id="finalInvTotal|'+liRowId+'" ></div>';
			paDataset[idx][9] = '<div id="realUseQty|'+liRowId+'" ></div>';
            ...
            */
				...
				paDataset[idx][5] = 'colspan=01~&nbsp; ';

				paDataset[idx][6] = 'colspan=01~&nbsp;';

				paDataset[idx][7] = 'colspan=01~&nbsp;';

				paDataset[idx][8] = 'colspan=05~&nbsp;'
				paDataset[idx][13] = 'colspan=02~&nbsp;';
                /*
				paDataset[idx][0] = 'colspan=05~'+paDataset[idx][0];
