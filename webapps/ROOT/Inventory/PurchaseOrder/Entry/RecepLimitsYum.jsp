...
<%!
    String getDataset(String lsPrv)
    {
        ...
        lsQry = "SELECT trim(provider_product_code), trim(CAST(limit_quantity AS VARCHAR)) FROM op_grl_reception_limits " +
