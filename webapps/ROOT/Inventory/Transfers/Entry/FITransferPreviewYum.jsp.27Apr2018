...
<body bgcolor="white"
	onLoad="initDataGrid('input'); resetFrame('FITransfer')">
	...
	<table align="center" width="98%" border="0">
		<tr>
			<td align="center" class="mainsubtitle"><br>
			<br> &#191; Desea confirmar esta transferencia de entrada de la
				unidad <%=msRemoteStore%> &#63; <br>
			<br></td>
		</tr>
		<tr>
			<td class="descriptionTabla" width="15%" nowrap>
				<form name="mainform" action="FITransferConfirmYum.jsp">
...
<%!String getQueryReport(HttpServletRequest poRequest) {
		...
		insertItemsF(poRequest, msLocalStoreId, msRemoteStoreId, msTransferType);
