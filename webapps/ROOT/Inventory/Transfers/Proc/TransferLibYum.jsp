...
<%!void writeOptions(javax.servlet.jsp.JspWriter out,
	...
	*/
	...
	String stripAccents(String psInput) {
		String lsAscii = "ABCDEFGHIJKLMNÑOPQRSTUVWXYZ0123456789 _abcdefghijklmnopqrstuvwxyz";
		String lsNuevo = "                              ";
	...
	private void updateRejects(String loTransfers) {
		...
		for (String loTransferRej : loRowsTransfersR) {
			...
			logApps.writeInfo(new Date() + " Se actualizará el restaurante "
			...
			if (!loNTransferId.equals("")) {
				...
				logApps.writeInfo("Se rechazó la transferencia en los restaurantes, los transfer_id son:\n\tLocal: "
								+ loTransferRej
								+ "\n\tVecino: "
								+ loNTransferId);
			}
		...
		// 		} else {
		// 			logApps.writeInfo("Se actualizará el restaurante vecino con la transferencia:"
		// 							+ loTransfers);
