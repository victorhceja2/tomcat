...
<%
    try
    {
        ...
        if(msReport.equals("3")){ //Se tiene que escoger una semana
            ...
            String lsIsClosed = validateInvClose(begindate);
		...
		//alert('Year-->'+lsYear+' Period-->'+lsPeriod+' Week-->'+lsWeek+' Day-->'+lsDay+ ' Begin-->'+lsBegin+ ' Current-->'+lsCurrent);
	     ...
	     <%
            ...
            if(lsIsClosed.equals("0")) //No fechas futuras
            {    
                msMessage = "No se pueden obtener reportes para d&iacute;as en los que no ha sido cerrado el inventario diario.";
            }
            else
            {
...
<html>
    ...
    <body onLoad="doAction()" style="margin-left: 0px; margin-right: 0px">
        ...
        <form name="mainform" action="InventoryCritReportFrm.jsp">
