		...
		for(var columnId=0; columnId< data[rowId].length;columnId++){
			if(in_array(columnId, cols)){
				...
				if(newValue.length == 0 || newValue == '')
					...
					newValue = '<a href=javascript:openPopUp(\"OrderDetailFrec.jsp?nomb=' + name + '&tel=' + data[rowId][3] + '&fec=' + data[rowId][4] + '&seq=' + data[rowId][8] + '&fre=' + data[rowId][6] + '\");>' + datagrid[rowId][columnId] + '</a>';
		...
		for(var columnId=0; columnId<data[rowId].length;columnId++){
			if(in_array(columnId,cols)){
				...
				if(newValue.length == 0 || newValue == '')
					...
					newValue = '<a href=javascript:openPopUp(\"OrderDetailFrec.jsp?nomb=' + name + '&tel=' + data[rowId][5] + '&fec=' + data[rowId][3] + '&seq=' + data[rowId][4] + '&fre=' + data[rowId][6] + '\");>' + datagrid[rowId][columnId] + '</a>';
				data[rowId][columnId] = newValue;
			}
		}
	}
