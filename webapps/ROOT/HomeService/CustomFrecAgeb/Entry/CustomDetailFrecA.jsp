...
<html>
	<head>
		...
		<script src="../Scripts/CustomLibFrecA.js"></script>
		<!--<script src="../Scripts/CustomDetailFrec.js"></script>-->
        <script type="text/javascript">
			var gaDataset = <%= msDataset %>;

			function executeReportCustom(){
				window.open("./CustomPrintA.jsp?hidFrecu=<%=msFrecId%>&hidDate=<%=msDate%>&hidDateH=<%=msDateH%>&hidAgeb=<%=msAgeb%>", "Impresion Reporte","width='10px', height='10px',left='35px', top='20px'");
			}	            
