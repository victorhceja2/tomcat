	...
	<head>
        ...
        <script type="text/javascript">
			...
			function executeReportCustom(){
				...
				ficha.innerHTML = "<tr class='bsDb_tr_header'><td class='bsDb_td_header_right' align='center', hclass='right, bclass='right', colspan='2'>Ultima Compra Cliente por AGEB</td></tr>" + 
								  "<tr class='bsDb_tr_header'>" +
								  "<td width='50%', align='left' class='bsDb_td_header_default'>AGEB</td>" + 
								  "<td width='50%', align='left' class='bsDb_td_header_default'>Clientes</td>";
