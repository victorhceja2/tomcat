...
<%--
##########################################################################################################
# Nombre Archivo  : DestChangeReportFrm.jsp
# Compania        : Yum Brands Intl
# Autor           : Mario Chavez Ayala     
# Objetivo        : Mostrar los tickets con cambio de destino.
# Fecha Creacion  : 31/Marzo/2006
# Inc/requires    : ../Proc/DestChangeLibYum.jsp
# Observaciones   : Se tiene que declarar un objecto moAbcUtils para que se pueda hacer 
#                   uso de los metodos en la libreria DestChangeLibYum.jsp
##########################################################################################################
--%>
...
<%
    ...
    moHtmlAppHandler.msReportTitle = getCustomHeader("Reporte cambio de destino", msTarget);
...
<html>
    <head>
        ...
        <script src="../Scripts/DestChangeReportYum.js"></script>
