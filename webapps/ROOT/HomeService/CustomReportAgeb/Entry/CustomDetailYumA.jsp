...
<html>
	<head>
        ...
        <script src="../Scripts/CustomLibYumA.js"></script>
        <script src="../Scripts/CustomDetailYumA.js"></script>
        <script type="text/javascript">
			function submitPrint(){
				window.open("./CustomPrintPA.jsp?hidFrecu=<%=msFrecId%>&hidDate=<%=msDate%>&hidFamily=<%=msFamilyId%>&hidAgeb=<%=msAgeb%>", "Impresion Reporte","width='10px', height='10px',left='35px', top='20px'");
			}
