...
<%@ include file="../Proc/CustomLibYumA.jsp" %>   
	...
	<head>
        ...
        <script type="text/javascript">
			...
			function executeReportCustom(){
				...
				ficha.innerHTML = "<tr class='bsDb_tr_header'><td class='bsDb_td_header_right' align='center', hclass='right, bclass='right', colspan='8'>Compras Clientes por AGEB</td></tr>" + 
								  "<tr class='bsDb_tr_header'><td width='80%', align='left' class='bsDb_td_header_default'>Calle</td>" +
								  "<td width='20%', align='left' class='bsDb_td_header_default'>AGEB</td>" + 
								  "<td width='20%', align='left' class='bsDb_td_header_default'>Clientes</td></tr>";
