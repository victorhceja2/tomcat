...
<%--
##########################################################################################################
# Nombre Archivo  : IdealUseReport14Frm.jsp
# Compania        : Yum Brands Intl
# Autor           : Sergio Cuellar
# Objetivo        : Uso ideal diario de 14 dias atras
...
<%
	try
	{
		...
		msTarget = request.getParameter("hidTarget");
                ...
                Date14 = getDate(msWeek, msYear, msPeriod, msDay, 14);
	        TransReal = getTransReal(Date14);
...
<html>
	...
	<script type="text/javascript">
	    ...
	    var loGrid11   = new Bs_DataGrid('loGrid11');
            ...
            var PostresDataset     = parent.PostresDataset;
	</script>
	...
	<tr>
	    <td>
	        <b class="datagrid-leyend">Uso ideal de 14 d&iacute;as atr&aacute;s <%= Date14 %></b>
            </td>
	</tr>
        <tr>
            <td>
