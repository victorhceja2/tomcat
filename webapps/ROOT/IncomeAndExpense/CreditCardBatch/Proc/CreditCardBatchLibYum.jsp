...
<%!
	...
	try {
	    FileWriter fstream = new FileWriter(filename);
		 ...
		 terminal_date_format = tmp[2].substring(2,4)+"-"+tmp[1]+"-"+tmp[0]; 
             ...
             terminal_failed = moAbcUtils.queryToString("SELECT termFailed FROM tmp_ccard WHERE terminal_id='"+terminal_id+"'");
	...
	String[][] resultset;
	resultset = new String[number_lines][6];
