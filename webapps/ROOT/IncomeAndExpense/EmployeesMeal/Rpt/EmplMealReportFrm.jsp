...
<%--
##########################################################################################################
# Nombre Archivo  : EmplMealReportFrm.jsp
# Compania        : Yum Brands Intl
# Autor           : Mario Chavez y Sergio Cuellar
# Objetivo        : Mostrar El reporte de comidas de empleado.
# Fecha Creacion  : 12/Mayo/2008
# Inc/requires    : ../Proc/EmplMealLibYum.jsp
# Observaciones   : Se tiene que declarar un objecto moAbcUtils para que se pueda hacer 
#                   uso de los metodos en la libreria EmplMealLibYum.jsp
##########################################################################################################
--%>
...
<%
    ...
    moHtmlAppHandler.msReportTitle = getCustomHeader("Reporte comidas de empleado", msTarget);
...
<html>
    <head>
        ...
        //Estas dos variables son requeridas en el Script EmplMealReportYum.js
