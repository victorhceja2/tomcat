...
(function(C,Z){
    ...
    function K(a,b,c){
        ...
        else if(r(b)&&X(b))for(d in b)a.setAttribute(d,b[d]);return e
    }
    function ta(a){
        return Da(a)?a:[a]
    }
    ...
    A.createElementNS&&!!A.createElementNS(Ga,"svg").createSVGRect,Pb=La&&parseInt(za.split("Firefox/")[1],10)<4,ia=A&&!ca&&!ya&&!!A.createElement("canvas").getContext,cb,db,Mb={},zb=0,ib,S,Pa,G,Aa=function(){},O=[],eb=0,Ka="div",Qb=/^[0-9]+$/,nb=["plotTop","marginRight","marginBottom","plotLeft"],pa,jb,rb,Za,ub,vb,wb,Ua,ab,bb,Fb,Gb,Hb,Ib,kb,xb,yb,I={},w;
    ...
    qb.prototype={
        dSetter:function(){
            ...
            c=[],d=this.now,e=a.length,f;
            if(d===1)c=this.toD;
            else if(e===b.length&&d<1)for(;e--;)f=parseFloat(a[e]),c[e]=isNaN(f)?a[e]:d*parseFloat(b[e]-f)+f;else c=b;
            this.elem.attr("d",c)
        },
        update:function(){
    ...
    Pa=function(a,b,c){
        ...
        d=new pa(b-Ya(b)),e,f=d[vb](),g=d[wb](),h=d[Ua](),i=d[ab](),k=d[bb](),j=S.lang,l=j.weekdays,m=j.shortWeekdays,d=s({
        ...
        for(e in d)for(;a.indexOf("%"+e)!==-1;)a=a.replace("%"+e,typeof d[e]==="function"?d[e](b):d[e]);return c?a.substr(0,
    ...
    w.numberFormat=function(a,b,c,d){
        var a=+a||0,e=S.lang,f=(a.toString().split(".")[1]||"").length,g,h,i=Math.abs(a);
        ...
        +b&&(d=Math.abs(i-g+Math.pow(10,-Math.max(b,
    ...
    S={
        ...
        credits:{
            enabled:!0,
            text:"Premium Restaurant Brands",
            href:"http://www.prb.net",
            position:{
                align:"right",
                x:-10,
                verticalAlign:"bottom",
    ...
    ja.prototype={
        ...
        brighten:function(a){
            ...
            else if(ma(a)&&a!==0)for(b=0;b<3;b++)c[b]+=F(a*255),c[b]<0&&(c[b]=0),c[b]>255&&(c[b]=255);
            return this
        },
    ...
    P.prototype={
        ...
        colorGradient:function(a,b,c){
            ...
            if(f){
                ...
                for(q in g)q!=="id"&&v.push(q,g[q]);for(q in j)v.push(j[q]);v=v.join(",");
        ...
        css:function(a){
            ...
            if(b)for(f in a)a[f]!==b[f]&&(c[f]=a[f],e=!0);if(e){
                ...
                if(ya&&!ca)L(this.element,a);
                    ...
                    for(f in a)g+=f.replace(/([A-Z])/g,b)+":"+a[f]+";";K(d,"style",g)
                }
                e&&this.added&&
        ...
        zIndexSetter:function(a,b){
            ...
            if(e){
                ...
                d=c.childNodes;
                for(i=0;i<d.length&&!h;i++)if(e=d[i],f=e.zIndex,e!==g&&(F(f)>a||!r(a)&&r(f)))c.insertBefore(g,e),h=!0;h||c.appendChild(g)
            }
            return h
        },
    ...
    Ca.prototype={
        ...
        rect:function(a,b,c,d,e,f){
            var e=X(a)?a.r:e,g=this.createElement("rect"),a=X(a)?a:a===z?{}:{
                x:a,
                y:b,
                width:t(c,0),
                height:t(d,0)
        ...
        symbols:{
            ...
            arc:function(a,b,c,d,e){
                var f=e.start,c=e.r||c||d,g=e.end-0.001,d=e.innerR,h=e.open,i=U(f),k=aa(f),j=U(g),g=aa(g),e=e.end-f<qa?0:1;
        ...
        clipRect:function(a,b,c,d){
            var e="highcharts-"+zb++,f=this.createElement("clipPath").attr({
                id:e
            }).add(this.defs),
    ...
    s(P.prototype,{
        ...
        htmlUpdateTransform:function(){
            if(this.added){
                ...
                0,f=this.y||0,g=this.textAlign||"left",h={
                    left:0,
                    center:0.5,
                    right:1
                }
                ...
                if(b.tagName==="SPAN"){
                    var i=this.rotation,j=F(this.textWidth),l=k&&k.whiteSpace,m=[i,g,b.innerHTML,this.textWidth,this.textAlign].join(",");
                    if(m!==this.cTT){
    ...
    if(!ca&&!ia){
        M={
            ...
            getSpanCorrection:function(a,b,c,d,e){
                var f=d?U(d*ha):1,g=d?aa(d*ha):0,h=p(this.elemHeight,this.element.offsetHeight),i;
                this.xCorr=f<0&&-a;
                this.yCorr=g<0&&-h;
                i=f*g<0;
                this.xCorr+=g*b*(i?
            ...
            pathToVML:function(a){
                for(var b=a.length,c=[];b--;)if(ma(a[b]))c[b]=B(a[b]*10)-5;
                    else if(a[b]==="Z")c[b]="x";
        ...
        var Bb={
            ...
            color:function(a,b,c,d){
                ...
                if(i){
                    ...
                    if(c==="fill")if(i==="gradient")c=m.x1||m[0]||0,a=m.y1||m[1]||0,n=m.x2||m[2]||0,m=m.y2||m[3]||0,x='angle="'+(90-W.atan((m-a)/(n-c))*180/qa)+'"',t();
                        else{
            ...
            symbols:{
                arc:function(a,b,c,d,e){
                    ...
                    d,c=e.innerR,d=U(f),i=aa(f),k=U(g),j=aa(g);
                    if(g-f===0)return["x"];
    ...
    Va.prototype={
        ...
        handleOverflow:function(a){
            ...
            [b.labelAlign],
            k=g.getBBox().width,j=b.getSlotWidth(),l=j,m=1,n,q={};
        ...
        render:function(a,b,c){
            ...
            t=this.getPosition(g,k,r,b),Y=t.x,t=t.y,s=g&&Y===d.pos+d.len||!g&&t===d.pos?-1:1,c=p(c,1);
            this.isActive=!0;
            if(q){
    ...
    {
        render:function(){
            var a=this,b=a.axis,c=b.horiz,d=a.options,e=d.label,f=a.label,g=d.width,h=d.to,i=d.from,k=r(i)&&r(h),j=d.value,l=d.dashStyle,m=a.svgElem,n=[],q,v=d.color,y=p(d.zIndex,0),o=d.events,x={},u=b.chart.renderer,n=b.log2lin;
            ...
            },o)d(q);e&&r(e.text)&&n&&n.length&&b.width>0&&b.height>0&&!n.flat?(e=D({
                align:c&&k&&"center",
                x:c?!k&&4:10,
    ...
    fa.prototype={
        ...
        defaultLabelFormatter:function(){
            ...
            else if(f&&a>=1E3)for(;f--&&g===z;)c=Math.pow(1E3,f+1),a>=c&&b*10%
        ...
        setAxisTranslation:function(a){
            ...
            if(j||i||d)if(h?(f=h.minPointOffset,g=h.pointRangePadding):(e=b.getClosest(),o(b.series,function(a){
        ...
        setTickInterval:function(a){
            ...
            j=d.minPadding,l=d.tickInterval,m=d.tickPixelInterval,n=b.categories,q=b.threshold,v=b.softThreshold,y,sa,x,u;
        ...
        unsquish:function(){
            var a=this.options.labels,b=this.horiz,c=this.tickInterval,d=c,e=this.len/(((this.categories?1:0)+this.max-this.min)/
                c),f,g=a.rotation,h=this.labelMetrics(),i,k=Number.MAX_VALUE,j,l=function(a){
                a/=e||1;
                a=a>1?ua(a):1;
                return a*c
            };
        ...
        renderUnsquish:function(){
            var a=this.chart,b=a.renderer,c=this.tickPositions,d=this.ticks,e=this.options.labels,f=this.horiz,g=this.getSlotWidth(),h=t(1,B(g-2*(e.padding||5))),i={},k=this.labelMetrics(),j=e.style.textOverflow,l,m=0,n,q;
        ...
        getOffset:function(){
            ...
            m,n=0,q=d.title,v=d.labels,y=0,sa=a.opposite,x=b.axisOffset,b=b.clipOffset,u=[-1,1,1,-1][h],s,z=a.axisParent,Y=this.tickSize("tick");
            k=a.hasData();
        ...
        render:function(){
            ...
            d.lineWidth,p,sa=b.hasRendered&&r(a.oldMin)&&!isNaN(a.oldMin),x=a.showAxis,u=$a(c.globalAnimation),t,s;
            ...
            o([k,j,l],function(a){
                ...
                for(c in a)if(!a[c].isActive)a[c].render(c,
                    !1,0),a[c].isActive=!1,e.push(c);Oa(function(){
        ...
        destroy:function(a){
            ...
            a||V(b);
            for(d in c)Ra(c[d]),c[d]=null;o([b.ticks,b.minorTicks,b.alternateBands],function(a){
                Ra(a)
            });
    ...
    fa.prototype.normalizeTimeTickInterval=function(a,
        ...
        for(g=0;g<c.length;g++)if(d=c[g],e=G[d[0]],f=d[1],c[g+1]&&a<=(e*f[f.length-1]+G[c[g+1][0]])/2)break;e===G.year&&a<5*e&&(f=[1,2,5]);
    ...
    Ob.prototype={
        ...
        move:function(a,b,c,d){
            var e=this,f=e.now,g=e.options.animation!==!1&&!e.isHidden&&(Q(a-f.x)>1||
                Q(b-f.y)>1),h=e.followPointer||e.len>1;
            s(f,{
                x:g?(2*f.x+a)/3:a,
                y:g?(f.y+b)/2:b,
        ...
        getPosition:function(a,b,c){
            ...
            f={},g=c.h||0,h,i=["y",d.chartHeight,b,c.plotY+d.plotTop,d.plotTop,d.plotTop+d.plotHeight],k=["x",d.chartWidth,a,c.plotX+d.plotLeft,d.plotLeft,d.plotLeft+d.plotWidth],j=!this.followPointer&&p(c.ttBelow,!d.inverted===!!c.negative),l=function(a,b,c,d,h,i){
                var k=c<d-e,m=d+e+c<b,l=d-e-c;
                d+=e;
                if(j&&m)f[a]=d;
                else if(!j&&k)f[a]=l;
                else if(k)f[a]=E(i-c,l-g<0?l:l-g);
                else if(m)f[a]=t(h,d+g+c>b?d:d+g);else return!1
            },m=function(a,b,c,d){
                var g;
    ...
    Xa.prototype={
        init:function(a,b){
            var c=
            b.chart,d=c.events,e=ia?"":c.zoomType,c=a.inverted,f;
            this.options=b;
            this.chart=a;
        ...
        runPointActions:function(a){
            ...
            g=b.hoverSeries,h,i=[Number.MAX_VALUE,Number.MAX_VALUE],k,j,l=[],m=[],n;
            if(!e&&!g)for(h=0;h<c.length;h++)if(c[h].directTouch||!c[h].options.stickyTracking)c=[];g&&(e?g.noSharedTooltip:g.directTouch)&&f?m=[f]:(o(c,function(b){
        ...
        drag:function(a){
            ...
            h=b.plotLeft,i=b.plotTop,k=b.plotWidth,j=b.plotHeight,l,m=this.selectionMarker,n=this.mouseDownX,q=this.mouseDownY,v=c.panKey&&a[c.panKey+"Key"];
        ...
        drop:function(a){
            ...
            if(this.selectionMarker){
                ...
                if(this.hasDragged||d)o(c.axes,function(c){
                    ...
                    [c.coll]])){
                        var f=
                        c.horiz,n=a.type==="touchend"?c.minPixelPadding:0,q=c.toValue((f?g:h)+n),f=c.toValue((f?g+i:h+k)-n);
                        e[c.coll].push({
                            axis:c,
                            min:E(q,f),
                            max:t(q,f)
    ...
    s(w.Pointer.prototype,{
        ...
        pinchTranslateDirection:function(a,b,c,d,e,f,g,h){
            var i=this.chart,k=a?"x":"y",j=a?"X":"Y",l="chart"+j,m=a?"width":"height",n=i["plot"+(a?
                "Left":"Top")],q,v,p=h||1,o=i.inverted,x=i.bounds[a?"h":"v"],u=b.length===1,t=b[0][l],r=c[0][l],s=!u&&b[1][l],z=!u&&c[1][l],w,c=function(){
        ...
        pinch:function(a){
            ...
            e=a.touches,f=e.length,g=b.lastValidTouch,h=b.hasZoom,i=b.selectionMarker,k={},j=f===1&&(b.inClass(a.target,"highcharts-tracker")&&c.runTrackerClick||b.runChartClick),l={};
            ...
            if(a.type==="touchstart")o(e,function(a,b){
                ...
                if(a.zoomEnabled){
                    ...
                    d=a.minPixelPadding,e=a.toPixels(p(a.options.min,a.dataMin)),f=a.toPixels(p(a.options.max,a.dataMax)),g=E(e,f),e=t(e,f);
                    b.min=E(a.pos,g-d);
        ...
        touch:function(a,b){
            ...
            ga=c.index;
            if(a.touches.length===
                1)if(a=this.normalize(a),c.isInsidePlot(a.chartX-c.plotLeft,a.chartY-c.plotTop)&&!c.openMenu){
    ...
    pb.prototype=
    {
        ...
        colorizeItem:function(a,b){
            ...
            c=b?c.itemStyle.color:g,h=b?a.legendColor||a.color||"#CCC":g,g=a.options&&a.options.marker,i={
                fill:h
            },k;
            d&&d.css({
                fill:c,
            ...
            if(f){
                if(g&&f.isMarker)for(k in i.stroke=h,g=a.convertAttribs(g),g)d=g[k],d!==z&&(i[k]=d);f.attr(i)
            }
        },
        ...
        scroll:function(a,b){
            ...
            g=g.inactiveColor,i=this.pager,k=this.padding;
            e>d&&(e=d);
    ...
    gb.prototype={
        ...
        redraw:function(a){
            ...
            j=c.length,l=j,m=this.renderer,n=m.isHidden(),q=[];
            Ta(a,this);
            ...
            if(h)for(l=j;l--;)if(a=c[l],a.options.stacking)a.isDirty=!0;o(c,function(a){
        ...
        reflow:function(a){
            var b=this,c=b.options.chart,d=b.renderTo,e=c.width||ka(d,"width"),f=c.height||ka(d,"height"),c=a?a.target:C;
        ...
        drawChartBox:function(){
            ...
            l=a.plotBackgroundImage,m=a.plotBorderWidth||0,n,q=this.plotLeft,p=this.plotTop,o=this.plotWidth,r=this.plotHeight,x=this.plotBox,u=this.clipRect,t=this.clipBox;
            n=i+(a.shadow?8:0);
        ...
        renderLabels:function(){
            ...
            b.items&&o(b.items,function(c){
                var d=s(b.style,c.style),e=F(d.left)+a.plotLeft,f=F(d.top)+a.plotTop+12;
                delete d.left;
                delete d.top;
    ...
    R.prototype={
        ...
        setData:function(a,b,c,d){
            var e=this,f=e.points,g=f&&f.length||0,h,i=e.options,k=e.chart,j=null,l=e.xAxis,m=l&&!!l.categories,n=i.turboThreshold,q=this.xData,v=this.yData,y=(h=e.pointArrayMap)&&h.length,a=a||[];
            h=a.length;
            b=p(b,!0);
            if(d!==!1&&h&&g===h&&!e.cropped&&!e.hasGroupedData&&e.visible)o(a,function(a,b){
                ...
                if(n&&h>n){
                    ...
                    if(ma(j)){
                        ...
                        e.xIncrement=m
                    }else if(Da(j))if(y)for(c=0;c<h;c++)j=a[c],q[c]=j[0],v[c]=j.slice(1,y+1);else for(c=0;c<h;c++)j=a[c],q[c]=j[0],v[c]=j[1];else Z(12)
                }else for(c=0;c<h;c++)if(a[c]!==z&&(j={
                    series:e
                },e.pointClass.prototype.applyOptions.apply(j,[a[c]]),e.updateParallelArrays(j,
                    c),m&&r(j.name)))l.names[j.x]=j.name;xa(v[0])&&Z(14,!0);
                e.data=[];
        ...
        generatePoints:function(){
            ...
            if(b&&(g!==(c=b.length)||k))for(m=0;m<c;m++)if(m===h&&!k&&(m+=g),b[m])b[m].destroyElements(),b[m].plotX=z;this.data=b;
            this.points=l
        },
        getExtremes:function(a){
            ...
            d=a.length;
            for(l=0;l<d;l++)if(k=
                c[l],j=a[l],i=j!==null&&j!==z&&(!b.isLog||j.length||j>0),k=this.getExtremesFromAll||this.options.getExtremesFromAll||this.cropped||(c[l+1]||k)>=g&&(c[l-1]||k)<=h,i&&k)if(i=j.length)for(;i--;)j[i]!==null&&(e[f++]=j[i]);else e[f++]=j;this.dataMin=Qa(e);
            this.dataMax=Fa(e)
        },
        translate:function(){
        ...
        drawPoints:function(){
            var a,b=this.points,c=this.chart,d,e,f,g,h,i,k,j,l=this.options.marker,m=this.pointAttr[""],n,q,o,y=this.markerGroup,r=p(l.enabled,this.xAxis.isRadial,this.closestPointRangePx>2*l.radius);
            if(l.enabled!==!1||this._hasPointMarkers)for(f=b.length;f--;)if(g=b[f],d=T(g.plotX),e=g.plotY,j=g.graphic,n=g.marker||{},q=!!g.marker,a=r&&n.enabled===z||n.enabled,o=g.isInside,a&&e!==z&&!isNaN(e)&&g.y!==null)if(a=g.pointAttr[g.selected?"select":""]||m,h=a.r,i=p(n.symbol,this.symbol),k=i.indexOf("url")===
        ...
        getAttribs:function(){
            ...
            if(!j||g<j||k)for(;g--;){
                ...
                if(j.options)for(t in m)r(c[m[t]])&&(k=!0);if(k){
                    c=c||{};
        ...
        destroy:function(){
            ...
            for(g in a)a[g]instanceof P&&!a[g].survive&&(d=c&&g==="group"?"hide":"destroy",a[g][d]());if(b.hoverSeries===a)b.hoverSeries=null;
            na(b.series,a);
        ...
        drawGraph:function(){
            var a=this,b=
            this.options,c=[["graph",b.lineColor||this.color,b.dashStyle]],d=b.lineWidth,e=b.linecap!=="square",f=(this.gappedPath||this.getGraphPath).call(this),g=this.fillGraph&&this.color||"none";
        ...
        applyZones:function(){
            var a=this,b=this.chart,c=b.renderer,d=this.zones,e,f,g=this.clips||[],h,i=this.graph,k=this.area,j=t(b.chartWidth,b.chartHeight),l=this[(this.zoneAxis||"y")+"Axis"],m,n=l.reversed,q=b.inverted,v=l.horiz,y,r,x,u=!1;
    ...
    fa.prototype.buildStacks=function(){
        var a=
        this.series,b,c=p(this.options.reversedStacks,!0),d=a.length,e;
        if(!this.isXAxis){
    ...
    R.prototype.setStackedPoints=function(){
        if(this.options.stacking&&!(this.visible!==
            ...
            var a=this.processedXData,b=this.processedYData,c=[],d=b.length,e=this.options,f=e.threshold,g=e.startFromThreshold?f:0,h=e.stack,e=e.stacking,i=this.stackKey,k="-"+i,j=this.negStacks,l=this.yAxis,m=l.stacks,n=l.oldStacks,q,o,y,r,x,u,s;
            l.stacksTouched+=1;
            for(x=0;x<d;x++){
                u=a[x];
                s=b[x];
    ...
    R.prototype.setPercentStacks=function(){
        ...
        o([b,"-"+b],function(b){
            var f;
            for(var g=d.length,h,i;g--;)if(h=d[g],e=a.getStackIndicator(e,h,a.index),f=(i=c[b]&&c[b][h])&&i.points[e.key],h=f)i=i.total?100/i.total:0,h[0]=da(h[0]*i),h[1]=da(h[1]*i),a.stackedYData[g]=h[1]
        })
    };
    ...
    s(R.prototype,{
        ...
        update:function(a,b){
            ...
            this.remove(!1);
            for(i in g)this[i]=z;s(this,I[a.type||f].prototype);
            o(h,function(a){
                c[a]=h[a]
            });
            this.init(d,
    ...
    var la=oa(R,{
        ...
        getStackPoints:function(){
            var a=[],b=[],c=this.xAxis,d=this.yAxis,e=d.stacks[this.stackKey],f={},g=this.points,h=this.index,i=d.series,k=i.length,j,l=p(d.options.reversedStacks,!0)?1:-1,m,n;
            if(this.options.stacking){
                ...
                o(b,function(g,i){
                    ...
                    if(f[g]&&!f[g].isNull)a.push(f[g]),o([-1,1],function(a){
                        ...
                        if(n)for(m=h;m>=0&&m<k;)p=n.points[m],p||(m===h?f[g][c]=!0:j[m]&&(r=e[g].points[m])&&(d-=r[1]-r[0])),m+=l;
    ...
    wa=oa(R,{
        ...
        getColumnMetrics:function(){
            ...
            var i=E(Q(c.transA)*(c.ordinalSlope||b.pointRange||c.closestPointRange||c.tickInterval||1),c.len),k=i*b.groupPadding,j=(i-2*k)/h,b=E(b.maxPointWidth||c.len,p(b.pointWidth,j*(1-2*b.pointPadding)));
            a.columnMetrics={
                width:b,
                offset:(j-
        ...
        translate:function(){
            ...
            a.translatedThreshold=e.getThreshold(c.threshold),g=p(c.minPointLength,5),h=a.getColumnMetrics(),i=h.width,k=a.barW=t(i,1+2*d),j=a.pointXOffset=h.offset;
            b.inverted&&(f-=0.5);
            c.pointPadding&&(k=ua(k));
            R.prototype.translate.apply(a);
            o(a.points,function(c){
                var d=E(p(c.yBottom,f),9E4),h=999+Q(d),h=E(t(-h,c.plotY),e.len+h),o=c.plotX+j,r=k,s=E(h,d),w,x=t(h,d)-s;
                Q(x)<g&&g&&(x=g,w=!e.reversed&&!c.negative||e.reversed&&c.negative,s=Q(s-f)>g?d-g:f-(w?g:0));
                c.barX=o;
                c.pointWidth=i;
                c.tooltipPos=b.inverted?[e.len+
                e.pos-b.plotLeft-h,a.xAxis.len-o-r/2,x]:[o+r/2,h+e.pos-b.plotTop,x];
                c.shapeType="rect";
    ...
    ea={
        ...
        translate:function(a){
            this.generatePoints();
            var b=0,c=this.options,d=c.slicedOffset,e=d+c.borderWidth,f,g,h,i=c.startAngle||0,k=this.startAngleRad=qa/180*(i-90),i=(this.endAngleRad=qa/180*(p(c.endAngle,i+360)-90))-k,j=this.points,l=c.dataLabels.distance,c=c.ignoreHiddenPoint,m,n=j.length,o;
    ...
    R.prototype.drawDataLabels=function(){
        var a=this,b=a.options,c=b.cursor,d=b.dataLabels,e=a.points,f,g,h=a.hasRendered||0,i,k,j=p(d.defer,!0),l=a.chart.renderer;
        if(d.enabled||a._hasPointLabels)a.dlProcessOptions&&a.dlProcessOptions(d),k=a.plotGroup("dataLabelsGroup","data-labels",j&&!h?"hidden":
            ...
            if(j&&!h)e.dataLabel=j.destroy();
                ...
                if(j)if(r(i))j.attr({
                    ...
                    if(c)B.cursor=c;
                    for(t in j)j[t]===z&&delete j[t];j=e.dataLabel=l[h?"text":"label"](i,0,-9999,d.shape,null,null,d.useHTML).attr(j).css(s(u,B)).add(k).shadow(d.shadow)
                }
                j&&
    ...
    R.prototype.alignDataLabel=function(a,b,c,d,e){
        var f=this.chart,g=f.inverted,h=p(a.plotX,-9999),i=p(a.plotY,-9999),k=b.getBBox(),j=f.renderer.fontMetrics(c.style.fontSize).b,l=c.rotation,m=c.align,n=this.visible&&(a.series.forceDL||f.isInsidePlot(h,B(i),g)||d&&f.isInsidePlot(h,g?d.x+1:d.y+d.height-1,g)),o=p(c.overflow,"justify")==="justify";
        if(n)d=s({
            x:g?f.plotWidth-i:h,
    ...
    if(I.pie)I.pie.prototype.drawDataLabels=function(){
        var a=
        this,b=a.data,c,d=a.chart,e=a.options.dataLabels,f=p(e.connectorPadding,10),g=p(e.connectorWidth,1),h=d.plotWidth,i=d.plotHeight,k,j,l=p(e.softConnector,!0),m=e.distance,n=a.center,q=n[2]/2,r=n[1],s=m>0,w,x,u,z=[[],[]],A,C,D,F,J,G=[0,0,0,0],L=function(a,b){
            return b.y-a.y
        };
                ...
                if(M){
                    ...
                    if(m>0){
                        ...
                        for(J=0;J<M;J++){
                            ...
                            if(K<J&&H[J]!==null)K=J;else for(x<M-J+K&&H[J]!==null&&(K=x-M+J);H[K]===null;)K++;
                            N.push({
                                i:K,
                                y:H[K]
                            });
        ...
        pan:function(a,b){
            ...
            o(b==="xy"?[1,0]:[1],function(b){
                var b=c[b?"xAxis":"yAxis"][0],d=b.horiz,h=a[d?"chartX":"chartY"],d=d?"mouseDownX":"mouseDownY",i=c[d],k=(b.pointRange||0)/2,j=b.getExtremes(),l=b.toValue(i-h,
                    !0)+k,k=b.toValue(i+b.len-h,!0)-k,i=i>h;
    ...
    s(Ia.prototype,{
        ...
        setState:function(a,b){
            var c=T(this.plotX),d=this.plotY,e=this.series,f=e.options.states,g=ba[e.type].marker&&e.options.marker,h=g&&!g.enabled,i=g&&g.states[a],k=i&&i.enabled===!1,j=e.stateMarkerGraphic,l=this.marker||{},m=e.chart,n=e.halo,o,a=a||"";
            o=this.pointAttr[a]||
            e.pointAttr[a];
