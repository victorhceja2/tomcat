             ...
             for(var li=0;li<laDepartmenteArray.length;li++){
                ...
                for(var lj=0;lj<laSectionArray.length;lj++){
                     ...
                     for(var lm=0;lm<laQuestionArray.length;lm++){
                        ...
                        writeToDiv("<br>Valor obtenido:"+liTotal+"<br> Valor Máximo:"+liMax+"<br> Porcentaje: <div class='rounded_min' style='width:200px;'><div style='width:"+(200*(liPer/100))+"px;background:"+lsColor+";color:gray;font-weight:bold'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+(liPer).toFixed(2)+"</div></div>");
                    }
                    ...
                    writeToDiv("<br><b>Total por sección</b> <div class='rounded' style='width:300px;'><div style='width:"+(300*(liCurrentSectionValue/100))+"px;background:"+lsColor+";color:gray;font-weight:bold'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+(liCurrentSectionValue).toFixed(2)+"</div></div>");
